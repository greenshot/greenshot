...
namespace Greenshot.CaptureCore.Interop
{
	...
	public interface IDispatch : IUnknown
	{
		...
		[PreserveSig]
		int Invoke(int dispIdMember, ref Guid riid, uint lcid, ushort wFlags, ref DISPPARAMS pDispParams, out object pVarResult, ref EXCEPINFO pExcepInfo, IntPtr[] pArgErr);
	}
}