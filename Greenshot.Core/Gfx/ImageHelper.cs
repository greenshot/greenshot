...
namespace Greenshot.Core.Gfx
{
	...
	public static class ImageHelper
	{
		...
		public static Bitmap ApplyTransparency(Bitmap blackBitmap, Bitmap whiteBitmap)
		{
		...
		/// <param name="processExif">true to process the exif information (rotate the image)</param>
		/// <returns>Image</returns>
		public static Image LoadImage(string filename, bool processExif = true)
		{
		...
		{
			return pixelformat.Equals(PixelFormat.Format32bppArgb) || pixelformat.Equals(PixelFormat.Format32bppPArgb) || pixelformat.Equals(PixelFormat.Format32bppRgb) || pixelformat.Equals(PixelFormat.Format24bppRgb);
		}
	}
}