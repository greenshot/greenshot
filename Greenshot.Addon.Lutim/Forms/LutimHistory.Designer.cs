...
namespace Greenshot.Addon.Lutim.Forms
{
	partial class LutimHistory
	{
		...
		{
			this.listview_lutim_uploads = new System.Windows.Forms.ListView();
			...
			this.SuspendLayout();
			// 
			// listview_lutim_uploads
			// 
			this.listview_lutim_uploads.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.listview_lutim_uploads.FullRowSelect = true;
			this.listview_lutim_uploads.Location = new System.Drawing.Point(12, 12);
			this.listview_lutim_uploads.Name = "listview_lutim_uploads";
			this.listview_lutim_uploads.Size = new System.Drawing.Size(510, 249);
			...
			this.Controls.Add(this.listview_lutim_uploads);
			this.LanguageKey = "lutim.history";
			this.Name = "LutimHistory";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.LutimHistoryFormClosing);
		...
		private System.Windows.Forms.ListView listview_lutim_uploads;
	}
}
