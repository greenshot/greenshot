...
namespace GreenshotPlugin.Gfx
{
	...
	public static class ImageHelper
	{
		...
		/// <returns>Bitmap</returns>
		public static Bitmap CreateEmpty(int width, int height, PixelFormat format = PixelFormat.DontCare, Color? backgroundColor = null, float horizontalResolution = 96f,
