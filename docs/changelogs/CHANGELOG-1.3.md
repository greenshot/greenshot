...
- Fixed a crash when opening the editor (issue [#925](https://github.com/greenshot/greenshot/issues/925)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1003](https://github.com/greenshot/greenshot/pull/1003)
- More graceful handling when saving to a locked/inaccessible file (issue [#946](https://github.com/greenshot/greenshot/issues/946)) — by [@danrhodes](https://github.com/danrhodes) in [PR #986](https://github.com/greenshot/greenshot/pull/986)
- Fixed a crash when changing the icon size in preferences (issue [#1007](https://github.com/greenshot/greenshot/issues/1007)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1010](https://github.com/greenshot/greenshot/pull/1010)
- Fixed holding CTRL while resizing not working as expected (issue [#1055](https://github.com/greenshot/greenshot/issues/1055)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1087](https://github.com/greenshot/greenshot/pull/1087)
- Fixed an error when making a capture (issue [#1021](https://github.com/greenshot/greenshot/issues/1021)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1022](https://github.com/greenshot/greenshot/pull/1022)
- Fixed line thickness being able to go out of range (issue [#1142](https://github.com/greenshot/greenshot/issues/1142)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1151](https://github.com/greenshot/greenshot/pull/1151)
- Fixed a race condition in editor layout updates (issue [#1169](https://github.com/greenshot/greenshot/issues/1169)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1210](https://github.com/greenshot/greenshot/pull/1210)
- Fixed region capture crashes (issues [#1153](https://github.com/greenshot/greenshot/issues/1153), [#1019](https://github.com/greenshot/greenshot/issues/1019), [#1031](https://github.com/greenshot/greenshot/issues/1031)) — by [@danrhodes](https://github.com/danrhodes) in [PR #1154](https://github.com/greenshot/greenshot/pull/1154)
- Fixed the tray icon disappearing permanently on RemoteApp/RAIL sessions (issue [#1324](https://github.com/greenshot/greenshot/issues/1324)) — by [@Lakritzator](https://github.com/Lakritzator) (Robin Krom) in [PR #1348](https://github.com/greenshot/greenshot/pull/1348)
- Fixed instabilities when changing the icon size, caused by disposing a shared font — by [@Christian-Schulz](https://github.com/Christian-Schulz) in [PR #981](https://github.com/greenshot/greenshot/pull/981)
- Fixed file format saving inconsistencies — by [@Christian-Schulz](https://github.com/Christian-Schulz) in [PR #1024](https://github.com/greenshot/greenshot/pull/1024)
- Fixed multiple toast notification issues, including a cross-thread exception — by [@overlord](https://github.com/overlord) in [PR #1147](https://github.com/greenshot/greenshot/pull/1147)
- Fixed processing of OneDrive hotkey settings (issue [#1170](https://github.com/greenshot/greenshot/issues/1170)) — by [@Lakritzator](https://github.com/Lakritzator) (Robin Krom)

### New Features

- Added a configurable Border effect via a new setting in Greenshot.ini — by [@weihongji](https://github.com/weihongji) in [PR #730](https://github.com/greenshot/greenshot/pull/730) (their first contribution to Greenshot!)
