...
- **release-documentation** (Skill & Agent): The user may explicitly invoke this workflow when release notes, changelogs, or release blog posts need to be generated or updated. It is not automatically invoked by models (see `.github/skills/release-documentation/SKILL.md` and `.github/agents/release-documentation-specialist.md`).
