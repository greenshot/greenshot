...
- **release-documentation** (Skill & Agent): Consult or invoke whenever release notes, changelogs, or release blog posts need to be generated or updated (see `.github/skills/release-documentation/SKILL.md` and `.github/agents/release-documentation-specialist.md`).
