...
namespace Greenshot.Addon.Editor.Configuration
{
	...
	public interface IEditorConfiguration : IIniSection<IEditorConfiguration>, INotifyPropertyChanged
	{
		...
		[DataMember(Name = "LastUsedFieldValues")]
		[Description("Field values, make sure the last used settings are re-used")]
		IDictionary<string, string> LastUsedFieldValues { get; set; }
		...
		[DefaultValue(ShowWindowCommand.Normal)]
		ShowWindowCommand ShowWindowCommand { get; set; }
