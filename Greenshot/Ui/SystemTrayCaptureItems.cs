		...
		private MenuItem CaptureArea
		{
			get
			{
				var menuItem = new MenuItem
				{
					...
					ClickAction = async item => { await CaptureHelper.CaptureRegionAsync(false).ConfigureAwait(false); }
				};
		...
		private MenuItem CaptureScreen
		{
			get
			{
				...
				var menuItem = new MenuItem
				{
					...
					ClickAction = async item => { await CaptureHelper.CaptureFullscreenAsync(false, ScreenCaptureMode.FullScreen).ConfigureAwait(false); }
				};
		...
		private MenuItem CaptureWindow
		{
			get
			{
				var menuItem = new MenuItem
				{
					...
					ClickAction = async item => { await CaptureHelper.CaptureWindowInteractiveAsync(false).ConfigureAwait(false); }
				};
