...
namespace Greenshot.Drawing {
	...
	public class TextContainer : RectangleContainer, ITextContainer {
		...
		public TextContainer(Surface parent) : base(parent) {
			Init();
			Field field = FieldFactory.CreateField(FieldType.FONT_BOLD);
			//field.PropertyChanged += FontPropertyChanged;
			AddField(field);
			AddField(FieldFactory.CreateField(FieldType.FONT_ITALIC));
			AddField(FieldFactory.CreateField(FieldType.FONT_FAMILY));
			AddField(FieldFactory.CreateField(FieldType.FONT_SIZE));
			AddField(FieldFactory.CreateField(FieldType.LINE_COLOR, GetType()));
			AddField(FieldFactory.CreateField(FieldType.LINE_THICKNESS, GetType()));
			AddField(FieldFactory.CreateField(FieldType.FILL_COLOR, GetType()));
		...
		void textBox_KeyDown(object sender, KeyEventArgs e) {
			...
			if(e.KeyCode == Keys.Escape || ((e.KeyCode == Keys.Return || e.KeyCode == Keys.Enter) && e.Modifiers != Keys.Shift)) {
			   	HideTextBox();
