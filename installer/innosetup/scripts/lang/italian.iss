...
it.depinstall_error=Si è verificato un errore durante l'installazione delle dipendenze.%n%nRiavvia il computer ed esegui nuovamente il programma d'installazione o installa manualmente le seguenti dipendenze:%n
