	...
	public sealed partial class ImgurHistory : ImgurForm
	{
		...
		private void Listview_imgur_uploadsSelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (listview_imgur_uploads.SelectedItems.Count > 0)
			{
				...
				{
					var imgurInfo = (ImgurInfo) listview_imgur_uploads.SelectedItems[0].Tag;
		...
		private void DeleteButtonClick(object sender, EventArgs e)
		{
			if (listview_imgur_uploads.SelectedItems.Count > 0)
			{
				for (var i = 0; i < listview_imgur_uploads.SelectedItems.Count; i++)
				{
					var imgurInfo = (ImgurInfo) listview_imgur_uploads.SelectedItems[i].Tag;
					var result = MessageBox.Show(Language.GetFormattedString("imgur", LangKey.delete_question, imgurInfo.Title),
