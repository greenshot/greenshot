...
We’re excited to announce the release of the first Release Candidate (RC) for Greenshot 1.3! 
...
- **Test & Report Bugs:** If you find any problems, please [report them on our issue tracker](https://greenshot.atlassian.net) with as much detail as possible.
- **Spread the Word:** Let your friends and colleagues know about Greenshot 1.3 RC!

#### Thank You

A huge thank you to all our contributors and users for your ongoing support. We couldn’t do this without you!

Stay tuned for the final release, and happy screenshotting!
