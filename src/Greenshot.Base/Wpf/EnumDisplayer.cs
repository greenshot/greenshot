...
public class EnumDisplayer : IValueConverter
{
    ...
    public ReadOnlyCollection<string> DisplayNames
    {
        get
        {
            ...
            if (genericTypeDefinition != null)
            {
                ...
                _displayValues = (IDictionary) Activator.CreateInstance(genericTypeDefinition.MakeGenericType(_type, typeof(string)));
            }
    ...
    {
        if (value == null || _displayValues == null || !_displayValues.Contains(value))
        {
            return null;
        }
    ...
    {
        if (value == null || _reverseValues == null || !_reverseValues.Contains(value))
        {
            return null;
        }
