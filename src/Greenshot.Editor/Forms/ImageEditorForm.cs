...
namespace Greenshot.Editor.Forms
{
    ...
    public partial class ImageEditorForm : EditorForm, IImageEditor
    {
        ...
        private void BindFieldControls()
        {
            ...
            new BidirectionalBinding(arrowHeadsDropDownButton, "SelectedTag", _surface.FieldAggregator.GetField(FieldType.ARROWHEADS), "Value", NotNullValidator.GetInstance());
