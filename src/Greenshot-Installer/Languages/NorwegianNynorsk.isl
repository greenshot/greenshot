...
AdditionalIcons=Ekstra snarvegar:
CreateDesktopIcon=Lag ikon på &skrivebordet
CreateQuickLaunchIcon=Lag eit &snarstart-ikon
ProgramOnTheWeb=%1 på nettet
UninstallProgram=Avinstaller %1
LaunchProgram=Køyr %1
AssocFileExtension=&Knyt %1 saman med filendinga %2
AssocingFileExtension=Knyter %1 saman med filendinga %2...
AutoStartProgramGroupDescription=Oppstart:
AutoStartProgram=Start %1 automatisk
AddonHostProgramNotFound=%1 vart ikkje funne i mappa du valde.%n%nVil du halde fram likevel?
