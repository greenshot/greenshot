...
internal static class IpcHelper
{
    ...
    /// </summary>
    /// <remarks>Using System.Text.Json for deserialization <see cref="IpcMessage"/>.</remarks>
    ...
    public static AppCommands Deserialize(byte[] rawData)
    {
        ...
        try
        {
            var msg = JsonSerializer.Deserialize<IpcMessage>(rawData);
    ...
    /// </summary>
    /// <remarks>Using System.Text.Json for serialization <see cref="IpcMessage"/>.</remarks>
    ...
    public static byte[] Serialize(AppCommands appCommands)
    {
        ...
        try
        {
            ...
            bytes = JsonSerializer.SerializeToUtf8Bytes(dto);
        }
        catch (Exception e)
        {
