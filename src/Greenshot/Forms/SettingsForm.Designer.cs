...
partial class SettingsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this.label_storagelocation = new Label();
        this.settings_cancel = new Button();
        this.settings_confirm = new Button();
        this.folderBrowserDialog1 = new System.Windows.Forms.FolderBrowserDialog();
        this.browse = new Button();
        this.label_screenshotname = new Label();
        ...
        this.tab_general = new TabPage();
        this.groupbox_network = new GroupBox();
        this.numericUpDown_daysbetweencheck = new System.Windows.Forms.NumericUpDown();
        this.label_checkperiod = new Label();
        this.checkbox_usedefaultproxy = new GreenshotCheckBox();
        this.groupbox_hotkeys = new GroupBox();
        this.label_lastregion_hotkey = new Label();
        this.lastregion_hotkeyControl = new HotkeyControl();
        this.label_region_hotkey = new Label();
        this.label_window_hotkey = new Label();
        this.label_fullscreen_hotkey = new Label();
        ...
        this.tab_capture = new TabPage();
        this.groupbox_editor = new GroupBox();
        this.numericUpdownIconSize = new System.Windows.Forms.NumericUpDown();
        this.label_icon_size = new Label();
        this.checkbox_editor_match_capture_size = new GreenshotCheckBox();
        this.groupbox_windowscapture = new GroupBox();
        ...
        this.groupbox_capture = new GroupBox();
        ...
        this.label_waittime = new Label();
        this.tab_output = new TabPage();
        this.tab_destinations = new TabPage();
        this.tab_printer = new TabPage();
        ...
        this.tab_plugins = new TabPage();
        this.groupbox_plugins = new GroupBox();
        this.listview_plugins = new System.Windows.Forms.ListView();
        this.button_pluginconfigure = new Button();
        this.tab_expert = new TabPage();
        this.groupbox_expert = new GroupBox();
        ...
        this.label_clipboardformats = new Label();
    ...
    private GroupBox groupbox_editor;
    ...
    private Label label_checkperiod;
    ...
    private Label label_fullscreen_hotkey;
    private Label label_window_hotkey;
    private Label label_region_hotkey;
    private HotkeyControl lastregion_hotkeyControl;
    private Label label_lastregion_hotkey;
    ...
    private GroupBox groupbox_capture;
    private GroupBox groupbox_windowscapture;
    private TabPage tab_capture;
    ...
    private Label label_screenshotname;
    ...
    private Label label_storagelocation;
    private TabPage tab_destinations;
    private TabPage tab_expert;
    private GroupBox groupbox_expert;
    private Label label_clipboardformats;
    ...
    private Label label_footerpattern;
