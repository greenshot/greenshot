...
public partial class DropboxSettingsWindow : Window
{
    private readonly IDropboxConfiguration _config;
    private readonly OutputFormat _initialFormat;
    private readonly bool _initialAfterUpload;

    public DropboxSettingsWindow(IDropboxConfiguration config)
    {
        _config = config;
