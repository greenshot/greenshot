...
public class ConvertDtoToLineContainerTests
{
    [Fact]
    public void ConvertDtoToDomain_LineContainerDto_Returns_LineContainer()
    {
        // Arrange
            ...
            Fields = [ new FieldDto
                {
                    ...
                    Scope = nameof(LineContainer),
                    Value = new IntFieldValueDto
                    {
                        Value = 3 // default in LineContainer is 2
                    }
                },
                new FieldDto
                {
                    ...
                    {
                        Value = colorBlue // default in LineContainer is Red
                    }
                },
                new FieldDto
                {
                    ...
                    {
                        Value = false // default in LineContainer is true
                    }
                }
            ]
        };
