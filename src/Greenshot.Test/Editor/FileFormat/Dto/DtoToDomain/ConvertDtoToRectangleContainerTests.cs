...
public class ConvertDtoToRectangleContainerTests
{
    [Fact]
    public void ConvertDtoToDomain_RectangleContainerDto_Returns_RectangleContainer()
    {
        // Arrange
            ...
            Fields = [ new FieldDto
                {
                    ...
                    Scope = nameof(RectangleContainer),
                    Value = new IntFieldValueDto
                    {
                        Value = 3 // default in RectangleContainer is 2
                    }
                },
                new FieldDto
                {
                    ...
                    {
                        Value = colorBlue // default in RectangleContainer is Red
                    }
                },
                new FieldDto
                {
                    ...
                    Value = new ColorFieldValueDto
                    {
                        Value = colorGreen // default in RectangleContainer is Transparent
                    }
                },
                new FieldDto
                {
                    ...
                    {
                        Value = false // default in RectangleContainer is true
                    }
                }
            ]
        };
