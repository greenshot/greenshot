...
public class ConvertIconContainerToDtoTests
{
    [Fact]
    public void ConvertDomainToDto_IconContainer_Returns_IconContainerDto()
    {
        // Arrange  
        ...
        // Act  
        var result = ConvertDomainToDto.ToDto(iconContainer);
        ...
        Assert.True(result.Icon.Length > 0);
    }
}
