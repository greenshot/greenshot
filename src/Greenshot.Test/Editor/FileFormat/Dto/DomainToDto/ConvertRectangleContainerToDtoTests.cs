...
public class ConvertRectangleContainerToDtoTests
{
    [Fact]
    public void ConvertDomainToDto_RectangleContainer_Returns_RectangleContainerDto()
    {
        // Arrange
        ...
        // see RectangleContainer.InitializeFields() for defaults
        ...
        // Act
        var result = ConvertDomainToDto.ToDto(rectangleContainer);
    ...
    public void ConvertDomainToDto_RectangleContainer_with_Field_Values_Returns_RectangleContainerDto_with_same_Values()
    {
        ...
        rectangleContainer.SetFieldValue(FieldType.LINE_THICKNESS, 3);
        rectangleContainer.SetFieldValue(FieldType.LINE_COLOR, colorBlue);
        rectangleContainer.SetFieldValue(FieldType.FILL_COLOR, colorGreen);
        rectangleContainer.SetFieldValue(FieldType.SHADOW, false);
