...
public class LineContainerSerializationTests
{
    /// <summary>
    /// Tests the serialization and deserialization process of an <see cref="LineContainer"/> object.
    /// </summary>
    /// <remarks>This test verifies that an <see cref="LineContainer"/> object can be correctly converted to
    /// its DTO representation, serialized, deserialized and then converted back to <see cref="LineContainer"/>.</remarks>
    [Fact]
    public void SerializeDeserialize_LineContainer()
    {
        // Arrange
        ...
        var deserializedDto = V2Helper.DeserializeDto<LineContainerDto>(serialized);
