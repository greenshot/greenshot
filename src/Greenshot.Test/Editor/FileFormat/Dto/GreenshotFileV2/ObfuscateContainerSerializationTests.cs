...
{
    /// <summary>
    /// Tests the serialization and deserialization process of an <see cref="ObfuscateContainer"/> object.
    /// </summary>
    /// <remarks>This test verifies that an <see cref="ObfuscateContainer"/> object can be correctly converted to
    /// its DTO representation, serialized, deserialized and then converted back to <see cref="ObfuscateContainer"/>.</remarks>
    [Fact]
    public void SerializeDeserialize_ObfuscateContainer()
    {
        // Arrange
