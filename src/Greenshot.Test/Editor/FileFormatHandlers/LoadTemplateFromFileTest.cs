...
/// <summary>
/// Contains unit tests for loading and validating various container types from Greenshot template using the
/// <see cref="GreenshotTemplateFormatHandler.LoadTemplateFromFile"/>.
/// </summary>
/// <remarks>Every test methode uses a .gst file from the TestData folder, which is expected to be present.
/// For every test method there is a .gst file in every supported Greenshot file version.
/// </remarks>
[Collection("DefaultCollection")]
public class LoadTemplateFromFileTest
{
    private readonly GreenshotTemplateFormatHandler _greenshotTemplateFormatHandler = new();


    public static IEnumerable<object[]> ArrowContainerTestData()
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "ArrowContainer_lt_100_200_wh_400_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "ArrowContainer_lt_100_200_wh_400_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "ArrowContainer_lt_100_200_wh_400_100.gst")];
    }

    [Theory]
    [MemberData(nameof(ArrowContainerTestData))]
    public void LoadArrowContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "RectangleContainer_lt_100_200_wh_150_80.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "RectangleContainer_lt_100_200_wh_150_80.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "RectangleContainer_lt_100_200_wh_150_80.gst")];
    }

    [Theory]
    [MemberData(nameof(RectangleContainerTestData))]
    public void LoadRectangleContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "LineContainer_lt_200_200_w_400.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "LineContainer_lt_200_200_w_400.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "LineContainer_lt_200_200_w_400.gst")];
    }

    [Theory]
    [MemberData(nameof(LineContainerTestData))]
    public void LoadLineContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "EllipseContainer_lt_200_200_wh_400_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "EllipseContainer_lt_200_200_wh_400_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "EllipseContainer_lt_200_200_wh_400_100.gst")];
    }

    [Theory]
    [MemberData(nameof(EllipseContainerTestData))]
    public void LoadEllipseContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "FreehandContainer_with_4_points.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "FreehandContainer_with_4_points.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "FreehandContainer_with_4_points.gst")];
    }

    [Theory]
    [MemberData(nameof(FreehandContainerTestData))]
    public void LoadFreehandContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "TextContainer_lt_300_200_wh_300_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "TextContainer_lt_300_200_wh_300_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "TextContainer_lt_300_200_wh_300_100.gst")];
    }

    [Theory]
    [MemberData(nameof(TextContainerTestData))]
    public void LoadTextContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "SpeechbubbleContainer_lt_200_200_wh_150_80.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "SpeechbubbleContainer_lt_200_200_wh_150_80.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "SpeechbubbleContainer_lt_200_200_wh_150_80.gst")];
    }

    [Theory]
    [MemberData(nameof(SpeechbubbleContainerTestData))]
    public void LoadSpeechbubbleContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "HighlightContainer_TextFilter_lt_310_70_wh_195_60.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "HighlightContainer_TextFilter_lt_310_70_wh_195_60.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "HighlightContainer_TextFilter_lt_310_70_wh_195_60.gst")];
    }

    [Theory]
    [MemberData(nameof(HighlightContainerTestData))]
    public void LoadHighlightContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "ObfuscateContainer_BlurFilter_lt_130_70_wh_180_70.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "ObfuscateContainer_BlurFilter_lt_130_70_wh_180_70.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "ObfuscateContainer_BlurFilter_lt_130_70_wh_180_70.gst")];
    }

    [Theory]
    [MemberData(nameof(ObfuscateContainerTestData))]
    public void LoadObfuscateContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "IconContainer_lt_400_200_wh_32_32.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "IconContainer_lt_400_200_wh_32_32.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "IconContainer_lt_400_200_wh_32_32.gst")];
    }

    [Theory]
    [MemberData(nameof(IconContainerTestData))]
    public void LoadIconContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "StepLabelContainer_lt_200_200_lt_500_300.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "StepLabelContainer_lt_200_200_lt_500_300.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "StepLabelContainer_lt_200_200_lt_500_300.gst")];
    }

    [Theory]
    [MemberData(nameof(StepLabelContainerTestData))]
    public void LoadStepLabelContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "ImageContainer_lt_300_200_wh_100_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "ImageContainer_lt_300_200_wh_100_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "ImageContainer_lt_300_200_wh_100_100.gst")];
    }

    [Theory]
    [MemberData(nameof(ImageContainerTestData))]
    public void LoadImageContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "SvgContainer_lt_300_200_wh_120_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "SvgContainer_lt_300_200_wh_120_100.gst")];
    }

    [Theory]
    [MemberData(nameof(SvgContainerTestData))]
    public void LoadSvgContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    {
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "MetafileContainer_lt_300_200_wh_120_100.gst")];
        yield return [Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "MetafileContainer_lt_300_200_wh_120_100.gst")];
    }

    [Theory]
    [MemberData(nameof(MetafileContainerTestData))]
    public void LoadMetafileContainerFromGreenshotTemplate(string filePath)
    {
        // Arrange
        var image = new Bitmap(800, 400);
    ...
    [Fact]
    public void LoadFromV0102GreenshotTemplateWithDifferentContainer()
    {
        // Arrange
        string filePath = Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.02", "Surface_with_11_different_DrawableContainer.gst");
        var image = new Bitmap(800, 400);
        var resultSurface = SimpleServiceProvider.Current.GetInstance<Func<ISurface>>().Invoke();
        resultSurface.Image = image;
    ...
    [Fact]
    public void LoadFromV0103GreenshotTemplateWithDifferentContainer()
    {
        // Arrange
        string filePath = Path.Combine("TestData", "GreenshotTemplate", "File_Version_1.03", "Surface_with_14_different_DrawableContainer.gst");
        var image = new Bitmap(800, 400);
        var resultSurface = SimpleServiceProvider.Current.GetInstance<Func<ISurface>>().Invoke();
        resultSurface.Image = image;
    ...
    [Fact]
    public void LoadFromV0201GreenshotTemplateWithDifferentContainer()
    {
        // Arrange
        string filePath = Path.Combine("TestData", "GreenshotTemplate", "File_Version_2.01", "Surface_with_14_different_DrawableContainer.gst");
        var image = new Bitmap(800, 400);
        var resultSurface = SimpleServiceProvider.Current.GetInstance<Func<ISurface>>().Invoke();
        resultSurface.Image = image;
