...
namespace Greenshot.Addon.Interfaces.Destination
{
	...
	public abstract class AbstractDestination : PropertyChangedBase, IDestination, IExportContext
	{
		...
		/// </summary>
		public virtual string Designation { get; protected set; }
		...
		///     Export a capture
		/// </summary>
		public virtual Func<IExportContext, ICapture, CancellationToken, Task<INotification>> Export { get; protected set; }

		/// <summary>
		///     This is a collection of child destinations, shown in the destination picker
		/// </summary>
		public virtual ObservableCollection<IDestination> Children { get; protected set; } = new ObservableCollection<IDestination>();
