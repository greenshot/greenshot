...
namespace Greenshot.Addon.Ui
{
	...
	/// </summary>
	public class PackIconGreenshot : PackIconBase<PackIconKindGreenshot>, INotifyPropertyChanged
	{
		private Size _iconSize = new Size(16, 16);
		private readonly IDictionary<PackIconKindGreenshot, Size> _sizeLookup = CreateIconSizes();
		...
		public new PackIconKindGreenshot Kind
		{
		...
		private static IDictionary<PackIconKindGreenshot, Size> CreateIconSizes()
		{
			return new Dictionary<PackIconKindGreenshot, Size>
			{
				{PackIconKindGreenshot.Greenshot, new Size(16,16)},
				{PackIconKindGreenshot.Confluence, new Size(182,182) }
			};
		}
