...
namespace Greenshot.Addon.Core
{
	public class AsyncCommand : ICommand
	{
		...
		/// <param name="allowMultipleExecutionsAtOnce">
		///     Whether or not this command can be executed several times in a row, or if
		///     it must wait until the previous command has been executed. Defaults to false.
		/// </param>
