...
namespace Greenshot.Addon.Configuration
{
	...
	public interface IUiConfiguration
	{
		...
		[DefaultValue(ClickActions.OpenLastInExplorer)]
		...
		[DefaultValue(ClickActions.ShowContextMenu)]
		...
		[DefaultValue(false)]
		[Tag(ConfigTags.LanguageKey, "settings_playsound")]
		bool PlayCameraSound { get; set; }

		[Description("Flash the screen after taking a capture.")]
		[DefaultValue(true)]
		[Tag(ConfigTags.LanguageKey, "settings_showflashlight")]
		bool ShowFlash { get; set; }
